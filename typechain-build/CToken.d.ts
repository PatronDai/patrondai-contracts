...
interface CTokenInterface extends Interface {
  functions: {
    ...
    initialize: TypedFunctionDescription<{
      encode([
        ...
        symbol_,
        decimals_
      ]: [string, string, BigNumberish, string, string, BigNumberish]): string;
    }>;
...
export class CToken extends Contract {
  connect(signerOrProvider: Signer | Provider | string): CToken;
  attach(addressOrName: string): CToken;
  deployed(): Promise<CToken>;

  on(event: EventFilter | string, listener: Listener): CToken;
  once(event: EventFilter | string, listener: Listener): CToken;
  addListener(eventName: EventFilter | string, listener: Listener): CToken;
  removeAllListeners(eventName: EventFilter | string): CToken;
  removeListener(eventName: any, listener: Listener): CToken;
